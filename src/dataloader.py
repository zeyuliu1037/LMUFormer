...
if __name__ == '__main__':
    dada_dir = '../data/speechcommands/data/'
    ...
    args = {
        'data_train': dada_dir + tr_data,
        'data_val': dada_dir + val_data,
        'data_eval': dada_dir + eval_data,
        'label_csv': dada_dir + label_csv,
        'batch_size': 39,
        'num_workers': 32,
    ...
    eval_loader = torch.utils.data.DataLoader(
            ...
            batch_size=args['batch_size'], shuffle=False, num_workers=args['num_workers'], pin_memory=True)
    print(len(train_loader)) # 663
    for i, (data, label) in enumerate(train_loader):
        print(i, data.shape, label.shape) # batch_size, audio_length, num_mel_bins
        break
